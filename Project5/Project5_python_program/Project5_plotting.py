...
class Plotter():
	...
	def plot_energy_alpha(self):
		...
		self.read_data("Energy_Alpha_Mdistance_omega_0.05.txt")
		fig3 = plt.figure()
		plt.plot(self.alpha, self.Energy)
		plt.hold("on")
		plt.plot(self.alpha, self.Energy_Exact)
		...
		if self.savefile == True:
			...
			fig3.savefig('../Plots/Energy_alpha_plot.pdf_omega005')
			fig4.savefig('../Plots/MeanDistance_alpha_plot_omega005.pdf')
			fig5.savefig('../Plots/Energy_alpha_plot.pdf_omega1')
			fig6.savefig('../Plots/MeanDistance_alpha_plot_omega1.pdf')
		else:
			plt.show()
