...
\begin{align*}
<E> = \frac{1}{Z}\displaystyle \sum_i E_ie^{-\beta E_i}
\end{align*}
Summing over all states $i$, with the given energies in table \ref{table:All_energies}, we get
\begin{align*}
<E> &= \frac{1}{Z}\left( 2(8J)e^{-8\beta J} + 2(-8J)e^{8\beta J} + 12\times0\times e^0 \right)\\
...
\begin{align*}
<E^2> &= \frac{1}{Z}\displaystyle \sum_i E_i^2 e^{-\beta E_i} \\
...
&= \frac{64J^2}{\cosh(8\beta J) + 3}\left(\frac{\cosh^2(8\beta J) + 3}{\cosh(8\beta J) + 3} - \frac{\sinh^2(8\beta J)}{\cosh(8\beta J) + 3} \right) \\
&= \frac{64J^2}{\cosh(8\beta J) + 3}\left(\frac{4}{\cosh(8\beta J) + 3} \right)\\
&= \frac{256J^2}{(\cosh(8\beta J) + 3)^2}
\end{align*}
...
\begin{align*}
<M> &= \frac{1}{Z} \displaystyle \sum_i M_i e^{-\beta E_i} = \frac{e^{4\beta J} - e^{4\beta J}}{\cosh(8\beta J) + 3} = 0 \\
<M^2> &= \frac{1}{Z}\displaystyle \sum_i M_i^2e^{-\beta E_i} = \frac{32(e^{8\beta J} + 1)}{\cosh(8\beta J) + 3}
\end{align*}
Which we can use to calculate the susceptibility $\chi$
\begin{align*}
\chi = <M^2> - <M>^2 = \frac{32(e^{8\beta J} + 1)}{\cosh(8\beta J) + 3}
\end{align*} 
