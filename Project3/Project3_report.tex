...
The results are promising. The orbits of all planets resembles to the orbits we observe. When looking at the plot for the first four planets, one may quickly be confused on the orbits, as it seems like the planets (with the exception of Earth) goes very high up in the z-axis. But this movement is at most up to $\pm 0.04AU$, which is a very very small change.
